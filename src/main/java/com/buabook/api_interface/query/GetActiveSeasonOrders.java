...
@Component
@Scope("prototype")
public class GetActiveSeasonOrders extends BuaBookApiQuerier {
	...
	public GetActiveSeasonOrders() {
		super(EMessageType.ORDER_LIST_RESPONSE, ERequestMethod.GET, API_URL, Maps.newHashMap(API_PARAMS));
	}
